...
// 電池残量閾値
#define BAT_LEVEL_1_VAL					(uint16_t)( 1023.0 * (1.95 / 3.0 ))		// 1.95V以上
#define BAT_LEVEL_2_VAL					(uint16_t)( 1023.0 * (1.72 / 3.0 ))		// 1.72V以上
#define BAT_LEVEL_3_VAL					(uint16_t)( 1023.0 * (1.5 / 3.0 ))		// 1.5V以上
#define BAT_LEVEL_CHG_FIN_VAL				(uint16_t)( 1023.0 * (2.0 / 3.0 ))		// 2.0V以上
