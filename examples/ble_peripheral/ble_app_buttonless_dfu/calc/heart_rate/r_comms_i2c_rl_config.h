...
#define COMMS_I2C_CFG_DEVICE0_SLAVE_ADDR        (0x53) /* Slave address */
#define COMMS_I2C_CFG_DEVICE0_CALLBACK          (rm_ob1203_callback0) /* Callback function */

/* For Device No.1 */
#define COMMS_I2C_CFG_DEVICE1_BUS_CH            (g_comms_i2c_bus0_extended_cfg)
#define COMMS_I2C_CFG_DEVICE1_SLAVE_ADDR        (0x53) /* Slave address */
#define COMMS_I2C_CFG_DEVICE1_CALLBACK          (rm_ob1203_callback1) /* Callback function */
