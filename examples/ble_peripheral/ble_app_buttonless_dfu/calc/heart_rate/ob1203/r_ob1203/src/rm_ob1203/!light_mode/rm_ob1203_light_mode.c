 ...
 *********************************************************************************************************************/
 ...
 #include "../../../../r_ob1203/inc/instances/rm_ob1203.h"
                                                 ...
                                                 rm_ob1203_light_data_t * const p_ob1203_data)
{
    ...
    {
        *p_light_data =
            (uint32_t) (((uint32_t)(p_raw_data->adc_data[3 * i + 2] & RM_OB1203_MASK_DATA) << 16) +
                        ((uint32_t)p_raw_data->adc_data[3 * i + 1] << 8) +
						(uint32_t)p_raw_data->adc_data[3 * i]);
