 ...
 *********************************************************************************************************************/
#define FUNC(x, y)      x ## y
#define XSTART(x, y)    FUNC(x, _Start)
#define XSTOP(x, y)     FUNC(x, _Stop)
...
void rm_ob1203_irq_callback0(void * p_args);
...
void rm_ob1203_irq_callback1(void * p_args);
...
{
    .p_start    = XSTART(RM_OB1203_CFG_INTC, RM_OB1203_CFG_DEVICE0_IRQ_NUMBER),
    .p_stop     = XSTOP(RM_OB1203_CFG_INTC, RM_OB1203_CFG_DEVICE0_IRQ_NUMBER),
};
#endif
...
#if (1 == RM_OB1203_CFG_DEVICE0_IRQ_CALLBACK_ENABLE)
void rm_ob1203_irq_callback0(void * p_args)
{
...
{
    .p_start = XSTART(RM_OB1203_CFG_INTC, RM_OB1203_CFG_DEVICE1_IRQ_NUMBER),
    .p_stop = XSTOP(RM_OB1203_CFG_INTC, RM_OB1203_CFG_DEVICE1_IRQ_NUMBER),
};
#endif
...
void rm_ob1203_callback1(rm_comms_callback_args_t * p_args)
{
 ...
 #if (1 == RM_OB1203_CFG_DEVICE1_IRQ_CALLBACK_ENABLE)
void rm_ob1203_irq_callback1(void * p_args)
{
    external_irq_callback_args_t args;
