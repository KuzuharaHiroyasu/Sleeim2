...
void heart_rate_start(void)
{
    ...
    ob1203_bio_ppg_data_calculate(&ob1203_bio, &raw_data, &ppg_data, &valid);
...
//	{
//	    i2c_heart_rate_write(0x15, 0x03, 0);
//	    i2c_heart_rate_write(0x16, 0x05, 0);
//	    /* Read raw data */
//	    result = ob1203_bio_ppg_raw_data_read(&ob1203_bio, &raw_data);
//	    if (false == result)
//	    {
