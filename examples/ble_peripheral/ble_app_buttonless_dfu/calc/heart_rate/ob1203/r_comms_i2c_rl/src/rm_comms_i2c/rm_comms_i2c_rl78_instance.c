...
#define XCLOSE(x)   FUNC(x, _Stop)
 ...
 #if (COMMS_I2C_CFG_BUS0_DRIVER_CH == 0)
#define COMMS_I2C_CFG_BUS0_DRIVER           R_IICA0
 #elif (COMMS_I2C_CFG_BUS0_DRIVER_CH == 1)
#define COMMS_I2C_CFG_BUS0_DRIVER           R_IICA1
 #endif
#elif (COMMS_I2C_CFG_BUS0_DRIVER_TYPE == COMMS_DRIVER_SAU_I2C)
 #if (COMMS_I2C_CFG_BUS0_DRIVER_CH == 0)
#define COMMS_I2C_CFG_BUS0_DRIVER           R_IIC00
 #elif (COMMS_I2C_CFG_BUS0_DRIVER_CH == 1)
#define COMMS_I2C_CFG_BUS0_DRIVER           R_IIC01
 #elif (COMMS_I2C_CFG_BUS0_DRIVER_CH == 2)
#define COMMS_I2C_CFG_BUS0_DRIVER           R_IIC10
 #elif (COMMS_I2C_CFG_BUS0_DRIVER_CH == 3)
#define COMMS_I2C_CFG_BUS0_DRIVER           R_IIC11
 #elif (COMMS_I2C_CFG_BUS0_DRIVER_CH == 4)
#define COMMS_I2C_CFG_BUS0_DRIVER           R_IIC20
 #elif (COMMS_I2C_CFG_BUS0_DRIVER_CH == 5)
#define COMMS_I2C_CFG_BUS0_DRIVER           R_IIC21
 #elif (COMMS_I2C_CFG_BUS0_DRIVER_CH == 6)
#define COMMS_I2C_CFG_BUS0_DRIVER           R_IIC30
 #elif (COMMS_I2C_CFG_BUS0_DRIVER_CH == 7)
#define COMMS_I2C_CFG_BUS0_DRIVER           R_IIC31
 #endif
#endif
#ifdef COMMS_I2C_CFG_BUS0_DRIVER
#define COMMS_I2C_CFG_BUS0_OPEN             XOPEN(COMMS_I2C_CFG_BUS0_DRIVER)
#define COMMS_I2C_CFG_BUS0_READ             XREAD(COMMS_I2C_CFG_BUS0_DRIVER)
#define COMMS_I2C_CFG_BUS0_WRITE            XWRITE(COMMS_I2C_CFG_BUS0_DRIVER)
#define COMMS_I2C_CFG_BUS0_STOP             XCOND(COMMS_I2C_CFG_BUS0_DRIVER)
#define COMMS_I2C_CFG_BUS0_CLOSE            XCLOSE(COMMS_I2C_CFG_BUS0_DRIVER)
#else
#define COMMS_I2C_CFG_BUS0_OPEN             NULL
#define COMMS_I2C_CFG_BUS0_READ             NULL
#define COMMS_I2C_CFG_BUS0_WRITE            NULL
#define COMMS_I2C_CFG_BUS0_STOP             NULL
#define COMMS_I2C_CFG_BUS0_CLOSE            NULL
#endif
#endif

#if (COMMS_I2C_CFG_DEVICE_NUM_MAX >= 2)
#if (COMMS_I2C_CFG_BUS1_DRIVER_TYPE == COMMS_DRIVER_I2C)
 #if (COMMS_I2C_CFG_BUS1_DRIVER_CH == 0)
#define COMMS_I2C_CFG_BUS1_DRIVER           R_IICA0
 #elif (COMMS_I2C_CFG_BUS1_DRIVER_CH == 1)
#define COMMS_I2C_CFG_BUS1_DRIVER           R_IICA1
 #endif
#elif (COMMS_I2C_CFG_BUS1_DRIVER_TYPE == COMMS_DRIVER_SAU_I2C)
 #if (COMMS_I2C_CFG_BUS1_DRIVER_CH == 0)
#define COMMS_I2C_CFG_BUS1_DRIVER           R_IIC00
 #elif (COMMS_I2C_CFG_BUS1_DRIVER_CH == 1)
#define COMMS_I2C_CFG_BUS1_DRIVER           R_IIC01
 #elif (COMMS_I2C_CFG_BUS1_DRIVER_CH == 2)
#define COMMS_I2C_CFG_BUS1_DRIVER           R_IIC10
 #elif (COMMS_I2C_CFG_BUS1_DRIVER_CH == 3)
#define COMMS_I2C_CFG_BUS1_DRIVER           R_IIC11
 #elif (COMMS_I2C_CFG_BUS1_DRIVER_CH == 4)
#define COMMS_I2C_CFG_BUS1_DRIVER           R_IIC20
 #elif (COMMS_I2C_CFG_BUS1_DRIVER_CH == 5)
#define COMMS_I2C_CFG_BUS1_DRIVER           R_IIC21
 #elif (COMMS_I2C_CFG_BUS1_DRIVER_CH == 6)
#define COMMS_I2C_CFG_BUS1_DRIVER           R_IIC30
 #elif (COMMS_I2C_CFG_BUS1_DRIVER_CH == 7)
#define COMMS_I2C_CFG_BUS1_DRIVER           R_IIC31
 #endif
#endif
#ifdef COMMS_I2C_CFG_BUS1_DRIVER
#define COMMS_I2C_CFG_BUS1_OPEN             XOPEN(COMMS_I2C_CFG_BUS1_DRIVER)
#define COMMS_I2C_CFG_BUS1_READ             XREAD(COMMS_I2C_CFG_BUS1_DRIVER)
#define COMMS_I2C_CFG_BUS1_WRITE            XWRITE(COMMS_I2C_CFG_BUS1_DRIVER)
#define COMMS_I2C_CFG_BUS1_STOP             XCOND(COMMS_I2C_CFG_BUS1_DRIVER)
#define COMMS_I2C_CFG_BUS1_CLOSE            XCLOSE(COMMS_I2C_CFG_BUS1_DRIVER)
#else
#define COMMS_I2C_CFG_BUS1_OPEN             NULL
#define COMMS_I2C_CFG_BUS1_READ             NULL
#define COMMS_I2C_CFG_BUS1_WRITE            NULL
#define COMMS_I2C_CFG_BUS1_STOP             NULL
#define COMMS_I2C_CFG_BUS1_CLOSE            NULL
#endif
#endif

#if (COMMS_I2C_CFG_DEVICE_NUM_MAX >= 3)
#if (COMMS_I2C_CFG_BUS2_DRIVER_TYPE == COMMS_DRIVER_I2C)
 #if (COMMS_I2C_CFG_BUS2_DRIVER_CH == 0)
#define COMMS_I2C_CFG_BUS2_DRIVER           R_IICA0
 #elif (COMMS_I2C_CFG_BUS2_DRIVER_CH == 1)
#define COMMS_I2C_CFG_BUS2_DRIVER           R_IICA1
 #endif
#elif (COMMS_I2C_CFG_BUS2_DRIVER_TYPE == COMMS_DRIVER_SAU_I2C)
 #if (COMMS_I2C_CFG_BUS2_DRIVER_CH == 0)
#define COMMS_I2C_CFG_BUS2_DRIVER           R_IIC00
 #elif (COMMS_I2C_CFG_BUS2_DRIVER_CH == 1)
#define COMMS_I2C_CFG_BUS2_DRIVER           R_IIC01
 #elif (COMMS_I2C_CFG_BUS2_DRIVER_CH == 2)
#define COMMS_I2C_CFG_BUS2_DRIVER           R_IIC10
 #elif (COMMS_I2C_CFG_BUS2_DRIVER_CH == 3)
#define COMMS_I2C_CFG_BUS2_DRIVER           R_IIC11
 #elif (COMMS_I2C_CFG_BUS2_DRIVER_CH == 4)
#define COMMS_I2C_CFG_BUS2_DRIVER           R_IIC20
 #elif (COMMS_I2C_CFG_BUS2_DRIVER_CH == 5)
#define COMMS_I2C_CFG_BUS2_DRIVER           R_IIC21
 #elif (COMMS_I2C_CFG_BUS2_DRIVER_CH == 6)
#define COMMS_I2C_CFG_BUS2_DRIVER           R_IIC30
 #elif (COMMS_I2C_CFG_BUS2_DRIVER_CH == 7)
#define COMMS_I2C_CFG_BUS2_DRIVER           R_IIC31
 #endif
#endif
#ifdef COMMS_I2C_CFG_BUS2_DRIVER
#define COMMS_I2C_CFG_BUS2_OPEN             XOPEN(COMMS_I2C_CFG_BUS2_DRIVER)
#define COMMS_I2C_CFG_BUS2_READ             XREAD(COMMS_I2C_CFG_BUS2_DRIVER)
#define COMMS_I2C_CFG_BUS2_WRITE            XWRITE(COMMS_I2C_CFG_BUS2_DRIVER)
#define COMMS_I2C_CFG_BUS2_STOP             XCOND(COMMS_I2C_CFG_BUS2_DRIVER)
#define COMMS_I2C_CFG_BUS2_CLOSE            XCLOSE(COMMS_I2C_CFG_BUS2_DRIVER)
#else
#define COMMS_I2C_CFG_BUS2_OPEN             NULL
#define COMMS_I2C_CFG_BUS2_READ             NULL
#define COMMS_I2C_CFG_BUS2_WRITE            NULL
#define COMMS_I2C_CFG_BUS2_STOP             NULL
#define COMMS_I2C_CFG_BUS2_CLOSE            NULL
#endif
#endif

#if (COMMS_I2C_CFG_DEVICE_NUM_MAX >= 4)
#if (COMMS_I2C_CFG_BUS3_DRIVER_TYPE == COMMS_DRIVER_I2C)
 #if (COMMS_I2C_CFG_BUS3_DRIVER_CH == 0)
#define COMMS_I2C_CFG_BUS3_DRIVER           R_IICA0
 #elif (COMMS_I2C_CFG_BUS3_DRIVER_CH == 1)
#define COMMS_I2C_CFG_BUS3_DRIVER           R_IICA1
 #endif
#elif (COMMS_I2C_CFG_BUS3_DRIVER_TYPE == COMMS_DRIVER_SAU_I2C)
 #if (COMMS_I2C_CFG_BUS3_DRIVER_CH == 0)
#define COMMS_I2C_CFG_BUS3_DRIVER           R_IIC00
 #elif (COMMS_I2C_CFG_BUS3_DRIVER_CH == 1)
#define COMMS_I2C_CFG_BUS3_DRIVER           R_IIC01
 #elif (COMMS_I2C_CFG_BUS3_DRIVER_CH == 2)
#define COMMS_I2C_CFG_BUS3_DRIVER           R_IIC10
 #elif (COMMS_I2C_CFG_BUS3_DRIVER_CH == 3)
#define COMMS_I2C_CFG_BUS3_DRIVER           R_IIC11
 #elif (COMMS_I2C_CFG_BUS3_DRIVER_CH == 4)
#define COMMS_I2C_CFG_BUS3_DRIVER           R_IIC20
 #elif (COMMS_I2C_CFG_BUS3_DRIVER_CH == 5)
#define COMMS_I2C_CFG_BUS3_DRIVER           R_IIC21
 #elif (COMMS_I2C_CFG_BUS3_DRIVER_CH == 6)
#define COMMS_I2C_CFG_BUS3_DRIVER           R_IIC30
 #elif (COMMS_I2C_CFG_BUS3_DRIVER_CH == 7)
#define COMMS_I2C_CFG_BUS3_DRIVER           R_IIC31
 #endif
#endif
#ifdef COMMS_I2C_CFG_BUS3_DRIVER
#define COMMS_I2C_CFG_BUS3_OPEN             XOPEN(COMMS_I2C_CFG_BUS3_DRIVER)
#define COMMS_I2C_CFG_BUS3_READ             XREAD(COMMS_I2C_CFG_BUS3_DRIVER)
#define COMMS_I2C_CFG_BUS3_WRITE            XWRITE(COMMS_I2C_CFG_BUS3_DRIVER)
#define COMMS_I2C_CFG_BUS3_STOP             XCOND(COMMS_I2C_CFG_BUS3_DRIVER)
#define COMMS_I2C_CFG_BUS3_CLOSE            XCLOSE(COMMS_I2C_CFG_BUS3_DRIVER)
#else
#define COMMS_I2C_CFG_BUS3_OPEN             NULL
#define COMMS_I2C_CFG_BUS3_READ             NULL
#define COMMS_I2C_CFG_BUS3_WRITE            NULL
#define COMMS_I2C_CFG_BUS3_STOP             NULL
#define COMMS_I2C_CFG_BUS3_CLOSE            NULL
#endif
#endif

#if (COMMS_I2C_CFG_DEVICE_NUM_MAX >= 5)
#if (COMMS_I2C_CFG_BUS4_DRIVER_TYPE == COMMS_DRIVER_I2C)
 #if (COMMS_I2C_CFG_BUS4_DRIVER_CH == 0)
#define COMMS_I2C_CFG_BUS4_DRIVER           R_IICA0
 #elif (COMMS_I2C_CFG_BUS4_DRIVER_CH == 1)
#define COMMS_I2C_CFG_BUS4_DRIVER           R_IICA1
 #endif
#elif (COMMS_I2C_CFG_BUS4_DRIVER_TYPE == COMMS_DRIVER_SAU_I2C)
 #if (COMMS_I2C_CFG_BUS4_DRIVER_CH == 0)
#define COMMS_I2C_CFG_BUS4_DRIVER           R_IIC00
 #elif (COMMS_I2C_CFG_BUS4_DRIVER_CH == 1)
#define COMMS_I2C_CFG_BUS4_DRIVER           R_IIC01
 #elif (COMMS_I2C_CFG_BUS4_DRIVER_CH == 2)
#define COMMS_I2C_CFG_BUS4_DRIVER           R_IIC10
 #elif (COMMS_I2C_CFG_BUS4_DRIVER_CH == 3)
#define COMMS_I2C_CFG_BUS4_DRIVER           R_IIC11
 #elif (COMMS_I2C_CFG_BUS4_DRIVER_CH == 4)
#define COMMS_I2C_CFG_BUS4_DRIVER           R_IIC20
 #elif (COMMS_I2C_CFG_BUS4_DRIVER_CH == 5)
#define COMMS_I2C_CFG_BUS4_DRIVER           R_IIC21
 #elif (COMMS_I2C_CFG_BUS4_DRIVER_CH == 6)
#define COMMS_I2C_CFG_BUS4_DRIVER           R_IIC30
 #elif (COMMS_I2C_CFG_BUS4_DRIVER_CH == 7)
#define COMMS_I2C_CFG_BUS4_DRIVER           R_IIC31
 #endif
#endif
#ifdef COMMS_I2C_CFG_BUS4_DRIVER
#define COMMS_I2C_CFG_BUS4_OPEN             XOPEN(COMMS_I2C_CFG_BUS4_DRIVER)
#define COMMS_I2C_CFG_BUS4_READ             XREAD(COMMS_I2C_CFG_BUS4_DRIVER)
#define COMMS_I2C_CFG_BUS4_WRITE            XWRITE(COMMS_I2C_CFG_BUS4_DRIVER)
#define COMMS_I2C_CFG_BUS4_STOP             XCOND(COMMS_I2C_CFG_BUS4_DRIVER)
#define COMMS_I2C_CFG_BUS4_CLOSE            XCLOSE(COMMS_I2C_CFG_BUS4_DRIVER)
#else
#define COMMS_I2C_CFG_BUS4_OPEN             NULL
#define COMMS_I2C_CFG_BUS4_READ             NULL
#define COMMS_I2C_CFG_BUS4_WRITE            NULL
#define COMMS_I2C_CFG_BUS4_STOP             NULL
#define COMMS_I2C_CFG_BUS4_CLOSE            NULL
#endif
#endif
